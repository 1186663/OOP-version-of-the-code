...
class World {
    ...
    // Prepare the background color and enable depth testing and face culling
    prepareBackground() {
        const gl = this.#gl;
    ...
    // Load a shader of a given type (VERTEX or FRAGMENT)
    ...
    // Prepare the vertex and fragment shaders and link them into a program
    prepareShaders() {
        const gl = this.#gl;
    ...
    // Load an object with vertices, colors, and optional indices
